<template>
  <div class="ease-sku-group">
    ...
    <sku-container :spec_id="spec_id" :sku="sku" :skuTree="ease.skuTreeData" :hasSkuImage="hasSkuImage" :onSkuLeafChange="handleSkuLeafChange"/>
...
export default {
  ...
  methods: {
    ...
    handleSelectSku (value) {
      let { index, optionValue, optionText } = this
