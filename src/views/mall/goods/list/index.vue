...
<template>
  <div>
    ...
    <section class="flex-items marginb20 marginr16 search">
      ...
      <el-select size="small" v-model="form.cat_id" clearable placeholder="请选择商品分类">
        <el-option
      ...
      <el-select size="small" v-model="form.status" clearable placeholder="请选择商品状态">
        <el-option
    ...
    <section class="flex-items marginb20">
      <router-link :to="'/mall/goods/add'"><el-button size="small" type="primary">添加商品</el-button></router-link>
    </section>
    <!-- 列表 -->
  ...
  methods: {
    ...
    async getTree() {
      let param = {
        ...
        url: "/Api/Admin/GoodsCat/getList",
        type:'get'
      };
