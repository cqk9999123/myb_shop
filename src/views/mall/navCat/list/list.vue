...
<template>
  <div class="list">
    ...
    >
      ...
      <el-table-column prop="uuid" width="200" align="center" label="导航分类标识"></el-table-column>
      ...
      <el-table-column prop="address" width="220" align="center" label="操作">
        <template slot-scope="item">
          <router-link class="marginr20" :to="'/mall/navCat/edit?id='+item.row.id">编辑</router-link>
  ...
  methods: {
    ...
    async statusChange(row) {
      ...
      let param = {
        ...
        url:"/Api/Admin/ShopNavCat/editVal",
      };
      let res = await this.request(param);
    },
    //修改排序
