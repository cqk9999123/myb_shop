...
<template>
  <div class="list">
    <el-table :data="list">
      ...
      <el-table-column prop="title" label="单页标题"></el-table-column>
      <el-table-column width="150" prop="uuid" label="标识">
         <template slot-scope="item">
      ...
      <el-table-column fixed="right" label="操作" align="center" width="180">
        <template slot-scope="item">
          <router-link :to="'/mall/pages/edit?id='+item.row.id">编辑</router-link>
  ...
  methods: {
    ...
    async statusChange(row) {
      ...
      let param = {
        ...
        url: "/Api/Admin/ShopPages/editVal"
      };
      let res = await this.request(param);
    },
    //修改排序
