<template>
  <section class="edit">
    ...
    <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="form_box">
      ...
      <el-form-item label="幻灯分类标识" prop="uuid">
        <el-input v-model="form.uuid" placeholder="请输入幻灯分类标识"></el-input>
      </el-form-item>
      <el-form-item>
        <div class="paddingl">
...
export default {
  ...
  methods: {
    ...
    async getInfo(id) {
      let param = {
        data:{id: id,},
        url:"/Api/Admin/ShopSlideCat/getInfo",
      };
      ...
      this.$refs.form.validate(async (valid) => {
        if (valid) {
          ...
          try{
            let param = {
              data:this.form,
              url:"/Api/Admin/ShopSlideCat/edit",
            };
            let res = await this.request(param);
