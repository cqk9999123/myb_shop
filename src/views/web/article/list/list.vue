...
<template>
  <div class="list">
    <el-table :data="list">
      ...
      <el-table-column width="150" prop="cat_title" label="文章分类"></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" align="center" width="180">
        <template slot-scope="item">
          <router-link :to="'/web/article/edit?id='+item.row.id">编辑</router-link>
