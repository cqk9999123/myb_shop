...
<template>
  <div>
    ...
    <section class="flex-items marginb20 marginr16 search">
      <el-input size="sweb" placeholder="请输入关键词" v-model="form.keyword" clearable>
        <el-select v-model="form.field" slot="prepend" placeholder="请选择" size="sweb">
          <el-option
    ...
    <section class="flex-items marginb20">
      <router-link :to="'/web/ArticleRec/add'"><el-button size="sweb" type="primary">添加推荐位</el-button></router-link>
    </section>
    <!-- 列表 -->
  ...
  methods: {
    ...
    async getList () {
      ...
      try{
        let param = {
          data:this.form,
          url:"/Api/Admin/ArticleRec/getList",
          type:"get",
        };
